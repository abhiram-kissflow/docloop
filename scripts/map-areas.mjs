...
{"assignments": {"<community id>": ["slug"], "<community id>": []}}`);
  ...
  fs.writeFileSync(path, JSON.stringify({
    _about: 'Graph community -> product area. Generated by scripts/map-areas.mjs --code; review in a diff. Regenerate when the graphify graph is refreshed.',
    generated_from: 'kissflow-cross-repo graphify graph',
    communities: out,
  }, null, 2) + '\n');
